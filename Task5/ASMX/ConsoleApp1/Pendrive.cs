...
namespace ConsoleApp1
{
    ...
    {
        public static void PendriveDisplay(dynamic select)                                                 //fn to display laptop variants
        {
        ...
        public static void PendriveSelection()                                            //fn to display laptop variant selected by the user
        {
            int price = 0;
            int qty = 0;
            int localprice = 0;
